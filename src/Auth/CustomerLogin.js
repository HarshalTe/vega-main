...
// import { InputGroupAddon } from "bootstrap";
import * as Yup from "yup";
import { postLogin, postCustomerLogin } from "../redux/action/LoginCreators";
...
const mapDispatchToProps = (dispatch) => ({
  ...
  postCustomerLogin: (data) => {
    dispatch(postCustomerLogin(data));
  },
});
