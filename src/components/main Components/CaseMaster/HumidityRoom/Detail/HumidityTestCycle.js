...
function HumidityTestCycle(props) {
...
let data = {
  ...
  ? props.editcase?.door_type_test.filter(
    (item) => 
    item.door_open_test_name === "Relative Humidity Test Cycle"||
    item.door_open_test_name === "Relative Humidity Test Cycle-I"
    ).length > 0
    ? props.editcase?.door_type_test.filter(
      (item) => 
      item.door_open_test_name === "Relative Humidity Test Cycle"||
  ...
  props.editcase?.door_type_test?.length > 0
  ? props.editcase?.door_type_test.filter(
    (item) => item.door_open_test_name === "Relative Humidity Test Cycle-II"
    ).length > 0
    ? props.editcase?.door_type_test.filter(
      (item) => item.door_open_test_name === "Relative Humidity Test Cycle-II"
      )[0]
  ...
  props.editcase?.door_type_test?.length > 0
  ? props.editcase?.door_type_test.filter(
    (item) => item.door_open_test_name === "Relative Humidity Test Cycle-III"
    ).length > 0
    ? props.editcase?.door_type_test.filter(
      (item) => item.door_open_test_name === "Relative Humidity Test Cycle-III"
      )[0]
...
const graphID1 = graphID?.length > 0 ?
    graphID?.filter(
        (item) =>
          item?.name === "RELATIVE HUMIDITY TEST CYCLE" ||
          item?.name === "RELATIVE HUMIDITY TEST CYCLE-I"
      )
    : [];
const graphID2 = graphID?.length > 0 ?
    graphID?.filter(
        (item) =>
          item?.name === "RELATIVE HUMIDITY TEST CYCLE-II"
      )
    : [];
const graphID3 = graphID?.length > 0 ?
    graphID?.filter(
        (item) =>
          item?.name === "RELATIVE HUMIDITY TEST CYCLE-III"
      )
    : [];
    console.log("object222",graphID,graphID1,graphID2,graphID3,"ee",staticGraphData2,staticGraphData1,staticGraphData3)
    ...
    <Card>
      <CardHeader className="bg-success text-white">
        <div className="">
          ...
          <strong>
            Trend For Relative Humidity Test Cycle-I (Temperature Vs Time)
          </strong>
        </div>
        Show
        <Switch
      ...
      <FinalReportVegaGraphHumidity
        ...
        testName="RELATIVE HUMIDITY TEST CYCLE-I (WITH AMBIENT)"
      ...
      <FinalReportVegaGraphHumidity
        test_id={graphID1[0]?.id}
        testName="RELATIVE HUMIDITY TEST CYCLE-I (WITHOUT AMBIENT)"
        x_min_excersion={staticGraphData1?.x_min_excersion ?? ""}
        x_max_excersion={staticGraphData1?.x_max_excersion ?? ""}
        y_min_excersion={staticGraphData1?.y_min_excersion ?? ""}
        y_max_excersion={staticGraphData1?.y_max_excersion ?? ""}
      ...
      />
       ...
       <CardHeader className="bg-success text-white">
        <div className="">
          <i className="fa fa-home mr-1" />
          <strong>
            Trend For Relative Humidity Test Cycle-II (Temperature Vs Time)
          </strong>
        </div>
        Show
        <Switch
      ...
      <FinalReportVegaGraphHumidity
        ...
        testName="RELATIVE HUMIDITY TEST CYCLE-II (WITH AMBIENT)"
      ...
      <FinalReportVegaGraphHumidity
        test_id={graphID2[0]?.id}
        testName="RELATIVE HUMIDITY TEST CYCLE-II (WITHOUT AMBIENT)"
        x_min_excersion={staticGraphData2?.x_min_excersion ?? ""}
        x_max_excersion={staticGraphData2?.x_max_excersion ?? ""}
        y_min_excersion={staticGraphData2?.y_min_excersion ?? ""}
        y_max_excersion={staticGraphData2?.y_max_excersion ?? ""}
      ...
      />
       <CardHeader className="bg-success text-white">
        <div className="">
          <i className="fa fa-home mr-1" />
          <strong>
            Trend For Relative Humidity Test Cycle-III (Temperature Vs Time)
          </strong>
        </div>
        Show
        <Switch
      ...
      <FinalReportVegaGraphHumidity
        ...
        testName="RELATIVE HUMIDITY TEST CYCLE-III (WITH AMBIENT)"
      ...
      <FinalReportVegaGraphHumidity
        test_id={graphID3[0]?.id}
        testName="RELATIVE HUMIDITY TEST CYCLE-III (WITHOUT AMBIENT)"
        x_min_excersion={staticGraphData3?.x_min_excersion ?? ""}
        x_max_excersion={staticGraphData3?.x_max_excersion ?? ""}
        y_min_excersion={staticGraphData3?.y_min_excersion ?? ""}
        y_max_excersion={staticGraphData3?.y_max_excersion ?? ""}
...
export default connect(mapStateToProps, mapDispatchToProps)(HumidityTestCycle);
