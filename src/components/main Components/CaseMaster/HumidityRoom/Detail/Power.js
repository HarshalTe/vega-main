...
// import ON_TOGGLE33 from "../../../../../redux/action/"
...
let data = {
  ...
  // const handleChange = (event) => {
  //   setChecked(event.target.checked);
  //   dispatch(ON_TOGGLE3(checked))
  //   console.log(checked,"checked")
  // }
  // const handleChange2 = (event) => {
  //   setChecked2(event.target.checked);
  //   dispatch(ON_TOGGLE32(checked2))
  //   console.log(checked2,"checked")
  // }
  // const handleChange3 = (event) => {
  //   setChecked3(event.target.checked);
  //   dispatch(ON_TOGGLE33(checked3))
    ...
    <Card>
      <CardHeader className="bg-success text-white">
        <div className="">
          ...
          <strong>
            Trend For Power Failure Test Cycle-I (Temperature Vs Time){" "}
          </strong>
        </div>
        Show
        <Switch
