...
import HumidityTestCycle from "./Detail/HumidityTestCycle";
import Graph from "./Detail/Graph";

const ColdRoom = (props) => {
    ...
    return (
      <React.Fragment>
        ...
        <TabContent activeTab={activeTab}>
          ...
          <TabPane tabId="humidity" className="bg-white">
            <Row>
              <Col sm="12" className="p-4">
                {/* <Door toggle={toggle} /> */}
                <HumidityTestCycle toggle={toggle} />
              </Col>
            </Row>
          </TabPane>
          ...
          <TabPane tabId="parameter" className="bg-white">
            <Row>
              <Col sm="12" className="p-4">
                <Parameter toggle={toggle} type_room={props?.editcase?.type_of_room} />
              </Col>
            </Row>
          </TabPane>
...
export default connect(mapStateToProps, mapDispatchToProps)(ColdRoom);
