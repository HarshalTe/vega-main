...
function ReeferGraph2(props) {
  ...
  if (
    ...
    for (let i = 0; i < uniqueTags.length; i++) {
      const range = props.editcase?.max_operating_range2;
                        ...
                        annotation: {
                          annotations: {
                            line1: {
                              ...
                              yMin: user.min_operating_range2,
                              yMax: user.min_operating_range2,
                              borderColor: "rgb(255, 99, 132)",
                              borderWidth: 2,
                              borderDash: [3],
                              borderDashOffset: 2,
                              label: {
                                content: `Minimum Temperature: ${user.min_operating_range2}`,
                                enabled: true,
                                color:"black",
                            ...
                            line2: {
                              type: "line",
                              drawTime: "afterDatasetsDraw",
                              yMin: user.max_operating_range2,
                              yMax: user.max_operating_range2,
                              borderColor: "red",
                              borderWidth: 2,
                              borderDash: [3],
                              borderDashOffset: 2,
                              label: {
                                content: `Maximum Temperature: ${user.max_operating_range2}`,
                                color:"black",
                                backgroundColor:"#00000030",
                                enabled: true,
                                position: "end",
