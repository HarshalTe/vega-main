    ...
    <Card>
      <CardHeader className="bg-success text-white">
        <div className="">
          ...
          <strong>Trend For Door Open Test Cycle (Temperature Vs Time)</strong>
        </div>
        Show
        <Switch
      checked={checked}
...
export default connect(mapStateToProps, mapDispatchToProps)(ReeferDoor);
