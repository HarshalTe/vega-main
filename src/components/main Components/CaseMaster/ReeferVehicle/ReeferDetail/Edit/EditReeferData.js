                    ...
                    <Col md={12}>
                      ...
                      <InputGroup>
                        ...
                        >
                          ...
                          <option value="hot_spot_1">
                            Hot Spot Image for{" "}
                            {props.editcase?.min_operating_range}°C to{" "}
                            {props.editcase?.max_operating_range}°C
                          </option>
                          <option value="cold_spot_1">
                            Cold Spot Image for{" "}
                            {props.editcase?.min_operating_range}
                            °C to {props.editcase?.max_operating_range}°C
                          </option>
                          <option value="hot_spot_2">
                            Hot Spot Image for{" "}
                            {props.editcase?.min_operating_range1}
                            °C to {props.editcase?.max_operating_range1}°C
                          </option>
                          <option value="cold_spot_2">
                            Cold Spot Image for{" "}
...
export default connect(mapStateToProps, mapDispatchToProps)(EditReeferData);
