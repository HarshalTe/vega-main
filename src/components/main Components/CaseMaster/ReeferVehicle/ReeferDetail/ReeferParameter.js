...
import { Card, CardHeader, CardBody, Button, Col, Row, InputGroup, Label, Form } from "reactstrap";
...
function ReeferParameter(props) {
  const accessToken = `${props.login?.login?.token}`;
  const param = useParams();

  const parameterDataPos = props.parameterData?.pos
  const parameterDataNeg = props.parameterData?.neg
  ...
  console.log("objecttest",test,test2)
  ...
  const handleSubmit = (values, { setSubmitting }) => {
    ...
    values.extras.pos2_3 = values.someFormFieldForPos2_3;
  values.extras.pos1_3 = values.someFormFieldForPos1_3;
  values.extras.pos2_2 = values.someFormFieldForPos2_2;
  values.extras.pos1_2 = values.someFormFieldForPos1_2;
    ...
    <Card>
      ...
      <div className="m-3">
        ...
        <div className="d-flex mt-5  justify-content-end font-weight-bold text-white f-12 text-center">
          ...
          >
            ...
            <p>HOT SPOT ({props.editcase?.pos1})</p>
          </div>
          <div
            style={{
          ...
          >
            ...
            <p>HOT SPOT ({props.editcase?.pos2})</p>
          </div>
        </div>
      </CardBody>
      ...
      <div className="m-3">
        ...
        <div className="d-flex mt-5  justify-content-end font-weight-bold text-white f-12">
          ...
          >
            <p>Average Maximum Temperature Point</p>
            <p>HOT SPOT ({props.editcase?.extras?.pos1_3})</p>
          </div>
          <div
            style={{
              backgroundColor: "green",
          ...
          >
            <p>Average Minimum Temperature Point</p>
            <p>COLD SPOT ({props.editcase?.extras?.pos2_3})</p>
          </div>
        </div>
      </CardBody>
    </Card>
...
export default connect(mapStateToProps,mapDispatchToProps)(ReeferParameter);
