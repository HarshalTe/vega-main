...
<Col md={6}></Col>
                          ...
                          <FormGroup>
                            {
                              ...
                              user.file_1 == "nofile.pdf" ? (
                                ...
                                <InputGroup>
                                  <a
                                    target={"blank"}
                                    href={`${imageUrl}${user.identification_no}/${user.file_1}`}
                                    rel="noreferrer"
                                  >
                                    {user?.file_1}
                                  </a>
                        ...
                        {/* <Col md={6}>
                          <Label for="file_2">Upload Position Logger</Label>
                          <FormGroup>
                            {
                              // props.cases?.isLoading ? (
                              //   <Loader2 />
                              // ) :
                              user.file_2 == "nofile.pdf" ? (
                                <InputGroup>
                                  <input
                                    component={CustomInput}
                                    type="file"
                                ...
                                <InputGroup>
                                  <a
                                    target={"blank"}
                                    href={`${imageUrl}${user.identification_no}/${user.file_2}`}
                                    rel="noreferrer"
                                  >
                                    {user.file_2}
                                  </a>
