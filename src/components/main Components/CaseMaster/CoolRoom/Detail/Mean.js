        ...
        <div className="text-center">
          ...
          <div style={{ border: "1px solid black", padding: "100px" }}>
            <p>
              ...
              {props.editcase?.mkt ?? ""} " A single derived temperature that,
              if maintained over a defined period of time, affords the same
              thermal challenge to a drug substance or drug product as would be
...
export default connect(mapStateToProps, mapDispatchToProps)(Mean);
