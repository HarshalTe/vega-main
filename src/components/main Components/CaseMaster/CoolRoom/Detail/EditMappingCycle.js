...
function EditMappingCycle(props) {
  ...
  const handleSubmit = (values, { setSubmitting }) => {
    ...
    props.onUpdateCycleData(data, user, toggle);
    setSubmitting(true);
    return;
  };
  ...
  const deleteData = () => {
    props.onDeleteCycle(data,data.id)
  };
  ...
  return (
    <>
      ...
      <Modal
        ...
        backdrop="static"
      >
        <ModalHeader toggle={toggle}>Edit Mapping Cycle</ModalHeader>
        <ModalBody>
          <Formik
            initialValues={{
              case_id: props.data.case_id,
              do_off_time: props.data?.do_off_time,
              start_date: props.data?.start_date,
              end_date: props.data?.end_date,
              set_limit_cross_out_time: props.data?.set_limit_cross_out_time,
              dcp_on_time: props.data?.dcp_on_time,
              set_limit_cross_in_time: props.data?.set_limit_cross_in_time,
              excersion: props.data?.excersion,
              recovery: props.data?.recovery,
              door_open_test_name: props.data?.door_open_test_name,
              set_temp: props.data?.set_temp,
              x_min_excersion: props.data?.x_min_excersion,
              x_max_excersion: props.data?.x_max_excersion,
              y_min_excersion: props.data?.y_min_excersion,
              y_max_excersion: props.data?.y_max_excersion,
              x_min_recovery: props.data?.x_min_recovery,
              x_max_recovery: props.data?.x_max_recovery,
              y_min_recovery: props.data?.y_min_recovery,
              y_max_recovery: props.data?.y_max_recovery,
            }}
            ...
            validationSchema={Yup.object().shape({
              ...
              // excersion: Yup.string().required("required"),
              ...
              return (
                <Form>
                  <Row className="form-group">
                    <Col md={6}>
                      <Label for="door_open_test_name">Name Of The Cycle</Label>
                      <InputGroup>
                        <Field
                  ...
                  <Row className="form-group">
                    <Col md={6}>
                      <Label for="dcp_on_time">On/Open time</Label>
                      <InputGroup>
                        <Field
                          component={CustomInput}
                          type="time"
                  ...
                  <Row className="form-group">
                    <Col md={6}>
                      <Label for="do_off_time">Off/Close Time</Label>
                      <InputGroup>
                        <Field
                          component={CustomInput}
                          type="time"
...
export default connect(mapStateToProps, mapDispatchToProps)(EditMappingCycle);
