            ...
            .map((user) => {
              ...
              return (
                <div id="aakash" key={user.id}>
                    ...
                    <div className="container">
                         <div className="row">
                              <div className="col-md" style={{border:'1px solid black'}}>
                                   <div className="row">
                                          <div className="col-md" style={{border:'1px solid black',margin:"2px"}}>
                                              <div className="row">
                                                    <div className="col-md page-container" style={{margin:"6px"}}>
                                                    <div className="row">
                                                   ...
                                                   <div className="row">
                                                         <div className="col-3   justify-content-center align-items-center" style={{border:'1px solid black'}}>
                                                         ...
                                                         <div className="col-3   justify-content-center align-items-center" style={{border:'1px solid black'}}>
                                                             <span style={{fontSize:'13px', paddingBottom:"8px"}}>
                                                                  {" "}
                                                                 {user.next_due_date}
                                                            </span>
                                                         </div>
                                                   ...
                                                   <div className="row">
                                                        ...
                                                        <div className="col">
                                                               ...
                                                               <div className="row">
                                                                  <div className="col" style={{border:'1px solid black',height:'40px'}}>
                                                                        <span className="font-weight-bold" style={{fontSize:'13px'}}>
                                                                           L
                                                                         </span>
                                                                  </div>
                                                   ...
                                                   <div className="row">
                                                        <div className="col-*" style={{border:'1px solid black',width:"14.36%"}}>
                                                            <span style={{fontSize:'13px'}}>
                                                                  {user.identification_no}
                                                             </span>
                                                        </div>
                                                        <div className="col-*" style={{border:'1px solid black',width:"14.28%"}}>
                                                            <span  style={{fontSize:'13px'}}>
                                                                   {user.model_no}
                                                             </span>
                                                        </div>
                                                        <div className="col-*" style={{border:'1px solid black',width:"14.28%"}}>
                                                            <span  style={{fontSize:'13px'}}>
                                                                  ...
                                                                  <div className="col-*" style={{border:'1px solid black',width:'4.70%'}}>
                                                                        <span  style={{fontSize:'13px'}}>
                                                   ...
                                                   <div className="row">
                                                         <div className="col   justify-content-center align-items-center" style={{border:'1px solid black'}}>
                                                                 <span style={{fontSize:'13px'}}>
                                                                   {dateFormat(
                                                   ...
                                                   <div className="col" style={{border:'1px solid black',fontSize:'13px'}}>
                                                   {dateFormat(cycle.start_date, "dd-mm-yyyy")}
                                                 </div>
                                                 <div className="col" style={{border:'1px solid black',fontSize:'13px'}}>
                                                 {dateFormat(cycle.end_date, "dd-mm-yyyy")}
                                                 </div>
                                                 <div className="col" style={{border:'1px solid black',fontSize:'13px'}}>
                                                 {cycle.set_temp}
                                                 </div>
                                                 ...
                                                 <div className="col" style={{border:'1px solid black',fontSize:'13px'}}>
                                                 {getTimeInSeconds(cycle?.do_off_time) > getTimeInSeconds(cycle?.set_limit_cross_in_time) 
                                                  ? cycle?.do_off_time 
                  ...
                  {myStateAc== true ? (
                  <div className="fourth-page" style={{"lineHeight":"14px"}}>
                    <RHeader user={user} />
                    <div className="container">
                         <div className="row">
                              <div className="col-md" style={{border:'1px solid black'}}>
                                              ...
                                              <div className="row">
                                                    <div className="col-md page-container" style={{margin:"6px"}}>
                                                      ...
                                                      <MainHeader />
                                                       ...
                                                       <div className="row">
                                                            <div className="col-6" style={{border:'1px solid black'}}>
                                                                  <span style={{fontSize:'13px',fontWeight:'bold'}}>Volume Of Area (Length*Width*Height)</span>
                                                            </div>
                                                            <div className="col-6" style={{border:'1px solid black'}}>
                                                                 <span style={{fontSize:'13px',fontWeight:'bold'}}>{paraAc[index]?.volume_area[0]?.length} X {paraAc[index]?.volume_area[0]?.width} X {paraAc[index]?.volume_area[0]?.height} ={(paraAc[index]?.volume_area[0]?.length*paraAc[index]?.volume_area[0]?.width*paraAc[index]?.volume_area[0]?.height).toFixed(2)} (Mtr.³)</span>
                                                            </div>
                                                       </div>
                                                       <div className="row">
                                                            <div className="col-6" style={{border:'1px solid black'}}>
                                                                  <span style={{fontSize:'13px',fontWeight:'bold'}}>Type Of Air Conditioning Unit</span>
                                                            </div>
                                                            <div className="col-6" style={{border:'1px solid black'}}>
                                                                 <span style={{fontSize:'13px',fontWeight:'bold'}}>{paraAc[index]?.ac_unit_type}</span>
                                                            </div>
                                                       </div>
                                                       <div className="row">
                                                            <div className="col-6" style={{border:'1px solid black'}}>
                                                                  <span style={{fontSize:'13px',fontWeight:'bold'}}>Total Installed Cooling Capacity (Including Split AC's If Any)</span>
                                                            </div>
                                                            <div className="col-6" style={{border:'1px solid black'}}>
                                                                 <span style={{fontSize:'13px',fontWeight:'bold'}}>{paraAc[index]?.installed_cooling_capacity}</span>
                                                            </div>
                                                       </div>
                                                       <div className="row">
                                                            <div className="col-6" style={{border:'1px solid black'}}>
                                                                  <span style={{fontSize:'13px',fontWeight:'bold'}}>Total No Of Cooling Units Installed</span>
                                                            </div>
                                                            <div className="col-6" style={{border:'1px solid black'}}>
                                                                 <span style={{fontSize:'13px',fontWeight:'bold'}}>{paraAc[index]?.cooling_units_installed}</span>
                                                            </div>
                                                       </div>
                                                       <div className="row">
                                                            <div className="col-6" style={{border:'1px solid black'}}>
                                                                  <span style={{fontSize:'13px',fontWeight:'bold'}}>No Of Blowers Installed</span>
                                                            </div>
                                                            <div className="col-6" style={{border:'1px solid black'}}>
                                                                 <span style={{fontSize:'13px',fontWeight:'bold'}}>{paraAc[index]?.no_blowers_installed==0  || paraAc[index]?.no_blowers_installed== null?"N/A":paraAc[index]?.no_blowers_installed}</span>
                                                            </div>
                                                       </div>
                                                       <div className="row">
                                                            <div className="col-6" style={{border:'1px solid black'}}>
                                                                  <span style={{fontSize:'13px',fontWeight:'bold'}}>Type Of Switching For Standby Unit(Automatic/Manual)</span>
                                                            </div>
                                                            <div className="col-6" style={{border:'1px solid black'}}>
                                                                 <span style={{fontSize:'13px',fontWeight:'bold'}}>{paraAc[index]?.switching_type}</span>
                                                            </div>
                                                       </div>
                                                       <div className="row">
                                                            <div className="col-6" style={{border:'1px solid black'}}>
                                                                  <span style={{fontSize:'13px',fontWeight:'bold'}}>Identification Number Of Individual AC & Its Operating period</span>
                                                            </div>
                                                            <div className="col-6" style={{border:'1px solid black'}}>
                                                              <div className="row">
                                                              ...
                                                              // console.log("object",i)
                                                                 return(<>
                                                                        ...
                                                                        <div className="row">
                                                                        <div className="col"style={{border:'1px solid black'}}>
                                                                        <span style={{fontSize:'13px',fontWeight:'bold'}}>{i.value_name}</span>
                                                                        </div>
                                                                        </div>
                                                                        <div className="row">
                                                                        <div className="col"style={{border:'1px solid black'}}>
                                                                         <span style={{fontSize:'13px',fontWeight:'bold'}}>{i.value}</span>
                                                                        </div>
                                                                        </div>
                                                                       </div>
                                                                        </>
                 ...
                 <div class="page-break"></div>
                    ...
                    {schematic_1 ? (
                      ...
                      <div className="fifth-page" style={{"lineHeight":"14px"}}>
                      <RHeader user={user} />
                      <div className="container">
                           <div className="row">
                                <div className="col-md" style={{border:'1px solid black'}}>
  ...
  ""
                ...
                Customer Address : {companyAddress}
                  ...
                  <div class="page-break"></div>
                   ...
                   {/* new */}
                  {myState2 == true  ? (
                      <div className="sixth-page pdf-h-w" style={{"lineHeight":"14px"}}>
                      <RHeader user={user} />
                      <div className="container">
                           <div className="row">
                                <div className="col-md" style={{border:'1px solid black'}}>
                              ...
                              {props.parameterData?.length > 0 &&
                                props.parameterData?.slice(45,60).map((par) => {
                                  return (
                                    <span
                                    key={par.id}
                                    className="w-50 h-50p test font-weight-bold d-flex align-items-center justify-content-center parameter"
                                    >
                                      {par.sensor}
                                    </span>
                                  );
  ...
  <div className="20-page pdf-h-w" >
                    ...
                    <div className="container">
                        ...
                        <div className="text-left ">
                          <div className="ml-3 mb-10" style={{fontSize:'13px'}}>
                            <h4 className="font-weight-bold text-underline">
                              Observation and Concluding Remarks
                            </h4>
                            <p className="space-line" style={{fontSize:'13px'}}>
                              {user.concluding_remark}
                            </p>
                          </div>

                          <div className="mb-10 ml-3" style={{fontSize:'13px'}}>
                            <h4 className="font-weight-bold text-underline">
                              Conclusion
                            </h4>
                            <p className="space-line" style={{fontSize:'13px'}}>{user.conclusion}</p>
                          </div>
                          <div className="row">
                                                         <div className="col" style={{border:'1px solid black'}}>
                                                              <span style={{fontSize:"13px",fontWeight:"bold"}}>
                                                    ...
                                                    <div className="row">
                                                        <div className="col" style={{border:'1px solid black'}}>
                                                                  <p style={{fontSize:"13px", marginTop:"1px",marginBottom:'2px'}}>Digitally Signed By : {user.prepared_by} </p>
                                                                  <p style={{fontSize:"13px", marginTop:"1px",marginBottom:'2px'}}> Reason :Authorised Signatory</p>
                                                                  <p style={{fontSize:"13px",  marginTop:"1px",marginBottom:'2px'}}>Date/Time : { user.prepared_by_time? <DataTime data={user.prepared_by_time} />: "N/A"}</p>
                                        
                                                        </div>
                                                        <div className="col" style={{border:'1px solid black'}}>
                                                              <p style={{fontSize:"13px", marginTop:"1px",marginBottom:'2px'}}>Digitally Signed By : {user.checked_by}</p>
                                                              <p style={{fontSize:"13px", marginTop:"1px",marginBottom:'2px'}}> Reason :Authorised Signatory</p>
                                                              <p style={{fontSize:"13px",  marginTop:"1px",marginBottom:'2px'}}> Date/Time :{ user.checked_by_time? <DataTime data={user.checked_by_time} />: "N/A"}</p>
                                                        </div>
                                                        <div className="col" style={{border:'1px solid black'}}>
                                                              <p style={{fontSize:"13px", marginTop:"1px",marginBottom:'2px'}}> Digitally Signed By : {user.reviewed_by} </p>
                                                              <p style={{fontSize:"13px", marginTop:"1px",marginBottom:'2px'}}> Reason :Authorised Signatory</p>
                                                              <p style={{fontSize:"13px",  marginTop:"1px",marginBottom:'2px'}}>Date/Time : { user.reviewed_by_time? <DataTime data={user.reviewed_by_time} />: "N/A"}</p>
                                                        </div>
                                                        <div className="col" style={{border:'1px solid black'}}>
                                                              <p style={{fontSize:"13px", marginTop:"1px",marginBottom:'2px'}}> Digitally Signed By : {user.approved_by}  </p>
                                                              <p style={{fontSize:"13px", marginTop:"1px",marginBottom:'2px'}}> Reason :Authorised Signatory</p>
                                                              <p style={{fontSize:"13px",  marginTop:"1px",marginBottom:'2px'}}>Date/Time : { user.approved_by_time? <DataTime data={user.approved_by_time} />: "N/A"} </p>
                                                        </div>
                                                    </div>
                          <div>
                            <div className="row">
                            ...
                            <div className=" test-b2 mt-2 mb-10">
                  ...
                  <div class="page-break"></div>
                    ...
                    <div className="21-page" style={{"lineHeight":"14px"}}>
   <RHeader user={user} />
   <div className="container">
        <div className="row">
             <div className="col-md" style={{border:'1px solid black'}}>
                          ...
                          <div className="pr-4 pt-2 pb-2 pl-4">
                            <div className="test-t test-b2 mt-4 mb-50">
                              ...
                              <div className="test p-4">
                                <p className="p-0 m-0" style={{fontSize:'14px',marginTop:'4px'}}>
                  ...
                  {/* {hotSpotImage.id < 0 ? ( */}
                         {/* {hotSpotImage.id < 0 ? ( */}
                  <div className="22-page" style={{"lineHeight":"14px"}}>
   <RHeader user={user} />
   <div className="container">
        <div className="row">
             <div className="col-md" style={{border:'1px solid black'}}>
...
{myState6==true ? (
 ...
 <div class="page-break"></div>
{myState6==true ? (
   <div className="28-page" style={{"lineHeight":"14px"}}>
   <RHeader user={user} />
   <div className="container">
        <div className="row">
             <div className="col-md" style={{border:'1px solid black'}}>
                         ...
                         <div className="col-md" style={{border:'1px solid black',margin:"2px"}}>
                             <div className="row">
                                   <div className="col-md page-container" style={{margin:"6px"}}>
                                     ...
                                     <p className="space-line p-2" style={{fontSize:'16px',textAlign: 'justify'}}>
...
<div class="page-break"></div>
<div className="29-page" style={{"lineHeight":"14px"}}>
                    <RHeader user={user} />
                    <div className="container">
                         <div className="row">
                              <div className="col-md" style={{border:'1px solid black'}}>
