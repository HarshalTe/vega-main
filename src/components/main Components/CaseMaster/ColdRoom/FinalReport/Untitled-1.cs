...
>
  ...
  {myState32 == true  ? (
                ...
                Customer Address : {companyAddress}
                  ...
                  <div class="page-break"></div>
                  <div className="19-page" style={{"lineHeight":"14px"}}>
   <RHeader user={user} />
...
{myState5 == true ? (
                    <div className="20-page" style={{"lineHeight":"14px"}}>
                    <RHeader user={user} />
                    <div className="container">
                         <div className="row">
                              <div className="col-md" style={{border:'1px solid black'}}>
                        ...
                        <div className="text-left ">
                          <div className="ml-3 mb-10">
                            <h4 className="font-weight-bold w-100 text-underline mt-1 ml-2 text-left" style={{fontSize:'13px'}}   >
...
{myState6==true ? (
   <div className="27-page" style={{"lineHeight":"14px"}}>
   <RHeader user={user} />
   <div className="container">
        <div className="row">
             <div className="col-md" style={{border:'1px solid black'}}>
