...
function RawData(props) {
  ...
  const filtetData = (values, { setSubmitting }) => {
    let user = {
      ...
      test_type_id: values.test_type_id == ""?null:values.test_type_id,
    };
  ...
  console.log("objectrow221", props, props?.testType?.testType);
  ...
  return (
    <Card className="pb-3">
      ...
      <CardBody className="p-0 pr-4 mt-4">
        ...
        <Modal className="modal-info modal-lg" isOpen={modal3} toggle={toggle3}>
          <ModalHeader toggle={toggle3}>Get Raw Data</ModalHeader>
          <ModalBody>
            <Formik
              initialValues={{
                sensor: [],
          ...
          <Row className="form-group d-flex justify-content-between align-items-end">
            ...
            <Row>
                        ...
                        <div>
                          <Row>
                            <Col md={10}>
                              <TextField
                                ...
                                name="sensors"
                                label="Sensors"
                                value={formProps.values.sensors}
                                onChange={formProps.handleChange}
                              />
                            </Col>
                            <Col>
                              <Button
                                ...
                                variant="contained"
                                onClick={() => {
                                  arrayHelpers.push(formProps.values.sensors);
                                  {
                                    formProps.setFieldValue("sensors", "");
                          ...
                          >
                            ...
                            <tbody>
                              {console.log(
                                "values",
                                formProps?.values?.sensor
                              )}
                              {formProps?.values?.sensor?.map(
                                (document, index) => {
                                  return (
                                    <tr key={index} >
                                      <td>{index + 1}</td>
              ...
              <Input
                ...
                id="test_type_id"
                step="1"
                placeholder="test_type_id"
                className="form-control"
                value={formProps.values.test_type_id}
                onChange={formProps.handleChange}
                // value={endTime > startTime ? endTime : startTime}
