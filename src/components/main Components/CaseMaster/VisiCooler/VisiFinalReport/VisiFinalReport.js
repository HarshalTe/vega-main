...
function VisiFinalReport(props) {
...
const isometric_6 =
  ...
  const filterDiagram2 = props.editcase?.files?.length > 0
    ...
    : "";
    // console.log("filterDiagram",filterDiagram2,filterDiagram,props.editcase?.files,filterDiagram?.length+1)
  ...
  const printMutliple = () => {
    ...
    printJS({
      ...
      type: "html",
      css: "../../CoolRoom/FinalReport/FinalReport.css",
      scanStyles: true,
      targetStyles: "[*]",
      font_size: "10pt",
      maxWidth: 1080,
  ...
  return (
    ...
    /> */}
      ...
      {/* <Switch
                        checked={
                          formProps.values.file_2_status == "1" ? true : false
                        }
                        onClick={() => {
                          formProps.values.file_2_status === "1"
                            ? formProps.setFieldValue("file_2_status", "0")
                            : formProps.setFieldValue("file_2_status", "1");
                        }}
                        size="medium"
                        color="success"
                      /> */}
        ...
        {props.cases?.isLoading ? (
          ...
          .map((user) => {
            ...
            const Description = [
              ...
              { sr: 1, name: `Location Diagram And Location Chart Of The Loggers`, pageNo: filterDiagram?.length+1 },
...
// console.log("filterDiagram",DescriptionF4[2]?.pageNo + DescriptionF4[1]?.pageNo + DescriptionF4[0]?.pageNo,DescriptionF4[2]?.pageNo , DescriptionF4[1]?.pageNo , DescriptionF4[0]?.pageNo)
            return (
                <div id="aakash">
                  <div style={{height:"645px",lineHeight:"12px"}} className="first-page pdf-h-w-2">
                    <RHeader user={user} />
                    <div className="p-0">
                  ...
                  <div className="second-page pdf-h-w-232">
                    ...
                    {/* <div className="second-page-data test pdf-h-w-2">
                      ...
                      <div className="test pdf-h-w-232">
                        <div className="second-main test pdf-h-w-232">
                          <div className="mb-50 f-24">
                            <div style={{}}>Thermal Qualification Study For</div>
                            <div style={{fontWeight:600}}>
                              "{user.type_of_room}" {user.type_of_cycle}
                            </div>
                            <div style={{}}>Identification No. : {user.identification_no}</div>
                            <div style={{}}>Located At</div>
                            <div style={{fontWeight:600}}>{user?.company?.name}</div>
                            <div style={{}}>{companyAddress}</div>
                          </div>
                          <table
                            className="table test"
                            style={{ border: "2px solid black" }}
                        ...
                        <div className="test">
                          <div className="test">
                            <div className="d-flex">
                              <span className="w-50 test-b p-1 test-r">
                                Objective{" "}
                              </span>
                              ...
                              <span className="w-20 test-b p-1">
                          ...
                          <div>
                            ...
                            <div className="test">
                              ...
                              <div className="d-flex">
                                ...
                                <span className="w-20 p-2 test-r">
                                  {user.capacity}
                                </span>
                        ...
                        <div
                         ...
                         >
                          <FinalReportVegaGraph2
                            ...
                            x_min_recovery={
                              staticGraphData.x_min_recovery ?? ""
                            }
                            x_max_recovery={
                              staticGraphData.x_max_recovery ?? ""
                            }
                            y_min_recovery={
                              staticGraphData.y_min_recovery ?? ""
                            }
                            y_max_recovery={
                              staticGraphData.y_max_recovery ?? ""
                            }
                          />
                        </div>
                      </div>
                    ...
                    <div className="p-1px test">
                      <div className="test ">
                        <div className="test">
                          ...
                          <div className="d-flex ">
                            <span className="w-60 font-weight-bold test-b p-2 test-r text-left">
                              Customer Name : {user?.company?.name}
                            </span>
                            <span className="w-40 test-b p-2 text-left">
                              Report Number : {user.report_no}
                            </span>
                          </div>
                        </div>
...
<div class="page-break"></div>
  ...
  ""
                        ...
                        {/* II */}
{myState22 == true ? (
  <div className="sixth-page pdf-h-w" style={
    myState22 == false ? { display: "none" } : {}
  }>
                    <RHeader user={user} />
                    <div className="p-1px test">
                      <div className="test ">
  ...
  <div className="19-page pdf-h-w">
                  ...
                  {/* <div className="25-page pdf-h-w">
                    ...
                    <div className="p-1px test">
                      <div className="test">
                        <MainHeader />
                        <div className="d-flex flex-column h-70v">
                          <h4 className="font-weight-bold w-100 text-underline mt-2 ml-2 mb-4 text-left">
                            Summary of Parameters Computed During Mapping
                            (Temperature)
                          </h4>
                          {props.test?.isLoading ? (
                            <Loader2 />
                          ) : props.parameterData?.length > 0 ? (
                            <div className="text-center p-2">
                              <div className="d-flex test w-100">
                                <span className="w-40 h-40p p-2 test font-weight-bold d-flex align-items-center justify-content-center para">
                                  Position
                                </span>

                                {props.parameterData?.map((par) => {
                                  return (
                                    <span className="w-20 h-40p test font-weight-bold d-flex align-items-center justify-content-center parameter">
                                      {par.sensor}
                                    </span>
                                  );
                                })}
                  ...
                  (MAX-MIN)TEMPERATURE °C
                          ...
                          <div className="d-flex mt-3 justify-content-end font-weight-bold mr-4 f-10 text-white ">
                            <div
                              className="bg-red"
                              style={{
                                padding: "8px",
                        ...
                        <div className="text-left ">
                          ...
                          <div>
                            <div className="test-t test-b2 mt-2 mb-10">
                              ...
                              {/* <div className="d-flex test">
                                <span className="w-25 test-r p-2">
                                  {user.prepared_by}
                                </span>
                                <span className="w-25 test-r p-2">
                                  {user.checked_by}
...
export default connect(mapStateToProps, mapDispatchToProps)(VisiFinalReport);
