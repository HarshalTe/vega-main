            ...
            return (
              <Formik
                initialValues={{
                  ...
                  no_of_cycles: user.no_of_cycles,
                  ...
                  return (
                    <Form>
                      <Row className="form-group">
                        ...
                        <Col md={6}>
                          <Label for="model_no">Make/Model No</Label>
                          <InputGroup>
                            {/* {props.cases?.isLoading ? (
                              <Loader2 />
                            ) : ( */}
                            <Field
                              ...
                              name="model_no"
                              id="model_no"
                              placeholder="Enter Make/Model No"
                              className={
                                "form-control" +
                        ...
                        <Col md={6}>
                          ...
                          <InputGroup>
                            ...
                            <Field
                              ...
                              name="cfa"
                              id="cfa"
                              placeholder="Enter CFA"
                              className={
                                "form-control" +
                                (formProps.errors.cfa && formProps.touched.cfa
                                  ? " is-invalid"
                                  : "")
                              }
                            />
...
export default connect(mapStateToProps, mapDispatchToProps)(VisiArea);
