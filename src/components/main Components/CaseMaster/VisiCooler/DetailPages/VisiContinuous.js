...
import EditVisiContinuous from "./EditVisiContinuous";
...
const Continuous3 = graphID?.length > 0 ?
  ...
  : [];
  // console.log("object222",props.testType?.testType[11].type_room,props.editcase?.type_of_room)
...
export default connect(mapStateToProps, mapDispatchToProps)(VisiContinuous);
