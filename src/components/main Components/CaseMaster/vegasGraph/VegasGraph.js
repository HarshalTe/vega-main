...
function VegasGraph(props) {
  ...
  // console.log("propsgraphprops",props)
  ...
  const graphdata = props.tests?.tests
    ?.filter((t) => {
  ...
  return (
    <Card className="p-3">
      ...
      <CardBody className="p-0">
        <h4 className="text-center pt-4 pr-4 pl-4 pb-1 ">{props.testName}</h4>
