...
function FormCalibration2(props) {
                          ...
                          <Row>
                            ...
                            <Col md={2}>
                              <TextField
                                ...
                                name="set_point"
                                label="Set Point"
                                value={formProps.values.set_point}
                                onChange={formProps.handleChange}
                              />
                            </Col>
                            <Col md={2}>
                              <TextField
                                ...
                                id="value_uuc"
                                name="value_uuc"
                                label="Nominal Value on UUC"
                                value={formProps.values.value_uuc}
                                onChange={formProps.handleChange}
                              />
                            </Col>
                            <Col md={2}>
                              ...
                              <Button
                                ...
                                onClick={() => {
                                  arrayHelpers.push({
                                    ...
                                    set_point: formProps.values.set_point,
                                    value_uuc:
                                      formProps.values.value_uuc,
                                      m1:
                                      formProps.values.m1,
                                      m2: formProps.values.m2,
                                      m3: formProps.values.m3,
                                      m4: formProps.values.m4,
                                  ...
                                  });
                                  {
                                    ...
                                    formProps.setFieldValue("value_uuc", "");
                                    formProps.setFieldValue("m1", "");
                                    formProps.setFieldValue("m2", "");
                                    formProps.setFieldValue("m3", "");
                                    formProps.setFieldValue("m4", "");
                                    formProps.setFieldValue(
                                      "expanded_uncertainty",
                                      ""
                                    );
                                    ...
                                    <tr key={index}>
                                      ...
                                      <td>
                                        <TextField
                                          ...
                                          label="Set Point"
                                          variant="outlined"
                                          name={`document.${index}.set_point`}
                                          value={document.set_point}
                                          id="set_point"
                                          onChange={formProps.handleChange}
                                        />
                                      </td>
                                      <td>
                                        <TextField
                                          ...
                                          label="Nominal Value on UUC"
                                          variant="outlined"
                                          name={`document.${index}.value_uuc`}
                                          value={document.value_uuc}
                                          id="value_uuc"
                                          onChange={formProps.handleChange}
                                        />
                                      </td>
...
export default connect(mapStateToProps, mapDispatchToProps)(FormCalibration2);
