...
function EditInvoice(props) {
  ...
  const handleSubmit = (values, { setSubmitting }) => {
    console.log("values in EditInvoice:", values);
    ...
    props.onUpdateInvoiceData(data, user, toggle, setSubmitting);
    setSubmitting(true);
    // setShowPdf(true);
        ...
        <ModalBody>
          <Formik
            initialValues={{
              ...
              type_of_invoice: props.data.invoice_type,
              ...
              net_amount: props.data.net_amount,
              cgst: props.data.cgst,
              gst: props.data.gst,
              total_tax_amount: props.data.total_tax_amount,
              total_order_amount: props.data.total_order_amount,
              is_paid: props.data?.is_paid,
              details: props.data.invoice_details,
            ...
            {(formProps) => (
              <Form>
                ...
                <Row className="form-group">
                  ...
                  <Col md={6}>
                    <Label for="quotation_ref_no">Quotation Reference No</Label>
                    <InputGroup>
                      <Field
                        component={CustomInput}
                        type="text"
                              ...
                              <tbody className="text-center">
                                ...
                                <tr>
                                  ...
                                  <td>
                                    ...
                                    {
                                      (formProps.values.net_amount = parseFloat(
