...
import DuplicateInvoicePdf from "./DuplicateInvoicePdf";
...
function Invoice(props) {
  ...
  const [state, setState] = useState({
    ...
    items: props.invoice?.isLoading ? [] : props.invoice?.invoice,
  });
        ...
        >
          <thead>
            <tr>
              ...
              <th scope="col">Quotation Reference No</th>
                ...
                .map((user, index) => {
                  return (
                    <tr key={index}>
                      ...
                      <td>{user.invoice_type}</td>
                      <td>{user.date}</td>
                      <td>{user.quotation_ref}</td>
                      <td>{user.purchase_order_no}</td>
                      <td>{user.purchase_order_date}</td>
                      <td>{user.is_paid == 0 ? "No" : "Yes"}</td>

                      <td className="d-flex justify-content-center">
                        <InvoicePaid data={user} />
                        <DuplicateInvoicePdf data={user} />
                        <InvoicePdf data={user} customer={props.customer} />
                        <EditInvoice data={user} />
                        <Button
                          ...
                          onClick={() => {
                            if (
                              ...
                              props.onDeleteInvoice(data, user.id);
                          }}
                        >
                          <i
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    onUpdateInvoiceData: (data, user, toggle, setSubmitting) =>
