...
import vega from "../../../assets/vaga-images/vega.png";
import printJS from "print-js";
import { connect } from "react-redux";
import { DateFormat } from "../../DateFormat/DateFormat";
var numberToWords = require("number-to-words");

function ShowInvoicePdf({ toggle, data, customer, ...props }) {
  ...
  return (
    <div className="invoice">
      {/* <Button onClick={toggle}>View Profoma Invoice</Button> */}
      ...
      <InvoicePrint id="InvoicePrint" className="test">
        <div className="d-flex justify-content-between p-1">
          <div>
            ...
            <div>
              ...
              <InvoicePTag>Email ID : support@vegacalibrations.com</InvoicePTag>
          ...
          <InvoiceDetail>
            ...
            <div className="p-1">
              ...
              <ISpan>
                ...
                <ValueDetail>
                  <DateFormat data={data.invoice_date} />
                </ValueDetail>
              </ISpan>
              <ISpan>
                <ArttributeDetail>Quotation Reference No</ArttributeDetail>
                <ValueDetail>{data.quotation_ref_no}</ValueDetail>
              </ISpan>
              <ISpan>
              ...
              <ISpan>
                ...
                <ValueDetail>{data.inv_gstin}</ValueDetail>
              </ISpan>
              <ISpan>
                <ArttributeDetail>Challan No</ArttributeDetail>
                <ValueDetail>{data.challan_no}</ValueDetail>
              </ISpan>
            </div>
          </InvoiceDetail>
        </div>
        ...
        <div className="f-12 font-weight-bold test text-center vega-gray">
...
export default connect(mapStateToProps)(ShowInvoicePdf);
