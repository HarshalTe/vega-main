...
function EditQuotation(props) {
  ...
  const handleSubmit = (values, { setSubmitting }) => {
    // console.log("values in EditQuotation:", values);
    ...
    props.onUpdateQuotationData(data, user, toggle, setSubmitting);
    setSubmitting(true);
    // setShowPdf(true);
        ...
        <ModalBody>
          <Formik
            initialValues={{
              ...
              type_of_quotation: props.data.quotation_type,
              ...
              details: props.data?.quotation_details,
          ...
          >
            {(formProps) => (
              <Form>
                ...
                <Row className="form-group">
                  <Col md={6}>
                    <Label for="type_of_quotation">Select Quotation Type</Label>
                    <InputGroup>
                      <Field
                        component={CustomSelect}
                        type="select"
