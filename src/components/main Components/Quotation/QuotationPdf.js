...
function QuotationPdf({ customer, data, ...props }) {
        ...
        <ModalBody>
          <QuotationPrint id="QuotationPrint" className="test">
              ...
              <div>
                <div className="">
                  ...
                  {company.name ===
                    ...
                    <QuotationPTag className="ml-5 pl-5">
                ...
                <div>
                  ...
                  <QuotationPTag>
                    Website : www.vegacalibrations.com
                  </QuotationPTag>
                </div>
              </div>
            ...
            <div className="d-flex w-100">
              ...
              <QuotationDetail>
                <ClientH6 className="client-h6">
                  VEGA QUOTATION DETAILS
                </ClientH6>
                <div className="p-1">
                  <ISpan>
            ...
            <Table className="table table-sm">
              ...
              <TBody>
                {data.quotation_details?.map((detail, index) => {
                  return (
                    <TR key={index}>
                      <TD>{index + 1}</TD>
                      <TD>{detail.desc}</TD>
            ...
            {data?.quotation_type === "With Calculation" && (
              <>
                        ...
                        <THead className="vega-p">
                          <TR>
                            ...
                            <TH className="text-right p-1" width="100">
                              ...
                              {data?.net_amount}
                              {/* {parseFloat(
                                data.quotation_details?.reduce(function (
                                  prev,
                                  cur
                                ) {
            ...
            {data?.quotation_type === "Without Calculation" && (
            ...
            <div>
              ...
              <p className="test p-1 m-0 f-10">
                ...
                Quotation Reference No. must appear on your Commercial Work
                Order (PO) or Delivery Challan
              </p>
              <p className="test p-1 m-0 f-10">
                2. The charges quoted are net. Presently GST 18% is applicable
                extra on above charges. However taxes as applicable at the time
                of providing services shall be payable by yourselves.
              </p>
              <p className="test p-1 m-0 f-10">
...
export default connect(mapStateToProps)(QuotationPdf);
