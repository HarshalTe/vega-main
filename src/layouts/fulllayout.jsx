...
import CustomerRouting from "../routes/customerRouting";
...
class Fulllayout extends React.Component {
  ...
  render() {
    ...
    } else if (this.props.login?.login?.length == 0) {
    ...
    else if (this.props.login?.login.user?.role == "supervisor")
      return (
        <div
          id="main-wrapper"
          data-theme="light"
    ...
    else if (this.props.login?.login.customer)
      return (
        <div
          id="main-wrapper"
          data-theme="light"
        ...
        >
          ...
          {/* Sidebar                                                                        */}
          {/*--------------------------------------------------------------------------------*/}
          <Sidebar data={this.state} {...this.props} routes={CustomerRouting} />
          {/*--------------------------------------------------------------------------------*/}
          {/* Page Main-Content                                                              */}
          {/*--------------------------------------------------------------------------------*/}
          <div className="page-wrapper d-block">
